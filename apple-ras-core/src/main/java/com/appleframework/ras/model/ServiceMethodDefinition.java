 ...
 * 日    期：12-5-31
 */
package com.appleframework.ras.model;
...
public class ServiceMethodDefinition {
     ...
     * HTTP请求的方法
     */
    private List<Object> httpAction;
    ...
    public List<Object> getHttpAction() {
        return httpAction;
    }

    public void setHttpAction(List<Object> httpAction) {
	...
	public String toString() {
		return "ServiceMethodDefinition [method=" + method + ", methodTitle=" + methodTitle + ", httpAction="
				+ httpAction + ", methodGroup=" + methodGroup + ", methodGroupTitle=" + methodGroupTitle + ", tags="
				+ tags + ", timeout=" + timeout + ", version=" + version + ", needInSession=" + needInSession
				+ ", ignoreSign=" + ignoreSign + ", obsoleted=" + obsoleted + "]";
	}
}
